...
typedef SWIFT_ENUM(NSInteger, AMAdResponseCode, closed) {
...
typedef SWIFT_ENUM(NSInteger, AMAdType, closed) {
  AMAdTypeUnknown = 0,
  AMAdTypeBanner = 1,
  AMAdTypeVideo = 2,
  AMAdTypeNative = 3,
...
typedef SWIFT_ENUM(NSInteger, AMClickThroughAction, closed) {
...
typedef SWIFT_ENUM(NSInteger, AMGender, closed) {
  AMGenderUnknown = 0,
  AMGenderMale = 1,
  AMGenderFemale = 2,
};
...
typedef SWIFT_ENUM(NSInteger, AMNativeAdAsset, closed) {
...
@property (nonatomic) enum AMClickThroughAction clickThroughAction;
- (void)registerViewForTracking:(UIView * _Nonnull)view withRootViewController:(UIViewController * _Nonnull)controller clickableViews:(NSArray<UIView *> * _Nullable)clickableViews;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
