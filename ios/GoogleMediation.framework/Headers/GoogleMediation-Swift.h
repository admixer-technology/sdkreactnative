...
#ifndef GOOGLEMEDIATION_SWIFT_H
#define GOOGLEMEDIATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GoogleMediation",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15GoogleMediation22AMAdAdapterBannerAdMob")
@interface AMAdAdapterBannerAdMob : NSObject <AMCustomAdapterBanner, GADBannerViewDelegate>
...
SWIFT_CLASS("_TtC15GoogleMediation20AMAdAdapterBannerDFP")
@interface AMAdAdapterBannerDFP : NSObject <AMCustomAdapterBanner, GADBannerViewDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, strong) id <AMCustomAdapterBannerDelegate> _Nullable bannerDelegate;
@property (nonatomic, strong) id <AMCustomAdapterDelegate> _Nullable delegate;
- (void)requestAdWith:(CGSize)size rootViewController:(UIViewController * _Nullable)rootViewController serverParameter:(NSString * _Nullable)parameterString adUnitId:(NSString * _Nullable)idString targetingParameters:(AMTargetingParameters * _Nullable)targetingParameters;
...
SWIFT_CLASS("_TtC15GoogleMediation28AMAdAdapterInterstitialAdMob")
@interface AMAdAdapterInterstitialAdMob : NSObject <AMCustomAdapterInterstitial, GADFullScreenContentDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC15GoogleMediation24AMAdAdapterRewardedAdMob")
